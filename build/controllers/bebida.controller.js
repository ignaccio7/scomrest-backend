...
var getBebidas = /*#__PURE__*/function () {
  ...
  return function getBebidas(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

var getBebida = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            _context2.next = 7;
            return connection.query("SELECT xbe.idProducto,xbe.marca,xbe.tipo,xbe.grado_alcoholico,xpro.nombre,xpro.descripcion,xpro.precio,xbe.image FROM bebida xbe, producto xpro WHERE xbe.idProducto = xpro.idProducto and xbe.idProducto=?", idProducto);
  ...
  return function getBebida(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

var addBebida = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, nombre, precio, descripcion, marca, tipo, grado_alcoholico, image, producto, result, busca, idProducto, bebida, connection, result2;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _req$body = req.body, nombre = _req$body.nombre, precio = _req$body.precio, descripcion = _req$body.descripcion, marca = _req$body.marca, tipo = _req$body.tipo, grado_alcoholico = _req$body.grado_alcoholico, image = _req$body.image;
            producto = {
              nombre: nombre,
              precio: precio,
          ...
          case 14:
            ...
            _context3.next = 17;
            return connection.query('INSERT INTO bebida SET ?', bebida);

          case 17:
            result2 = _context3.sent;
            console.log(result2);
            res.json({
              message: "bebida añadida"
            });
            _context3.next = 26;
            break;
  ...
  return function addBebida(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();

var deleteBebida = /*#__PURE__*/function () {
  ...
  return function deleteBebida(_x7, _x8) {
...
var updateBebida = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 9:
            ...
            _context5.next = 12;
            return connection.query('UPDATE bebida SET ? WHERE idProducto=?', [bebida, idProducto]);
  ...
  return function updateBebida(_x9, _x10) {
